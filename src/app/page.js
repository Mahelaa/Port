          ...
          <main className="portfolio-content">
            <div className="menu-grid">
              ...
              <div className="menu-item">
                ...
                <span className="menu-title">
                  <img 
                    src="https://win98icons.alexmeub.com/icons/png/msie2-2.png" 
                    alt=""
                    className="win98-icon"
                  />
                  SKILLS
          ...
          <footer className="win98-footer">
            <div className="copyright">
              <img 
                ...
                className="win98-icon small"
              />
              © {new Date().getFullYear()} Made by @Shane - ALL RIGHTS RESERVED
            </div>
      ...
      <style jsx global>{`
        * {
        ...
        .noise {
          ...
          opacity: 0.05; /* Changed from 0.1 to 0.05 */
          z-index: 1;
          pointer-events: none;
        }
        ...
        .tv-noise-bg {
          ...
          object-fit: cover;
          z-index: 0;
          opacity: 0.04; /* Changed from 0.08 to 0.04 */
          pointer-events: none;
          filter: contrast(1.1) brightness(0.9) blur(0.5px); /* Modified filter to be more subtle */
          mix-blend-mode: soft-light; /* Changed from hard-light to soft-light for subtlety */
        }
